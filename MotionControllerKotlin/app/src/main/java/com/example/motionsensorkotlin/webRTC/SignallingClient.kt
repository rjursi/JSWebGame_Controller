...
class SignallingClient {
    ...
    companion object {
        ...
        internal fun init( signalingInterface: SignalingInterface,ioSocket:IoSocket) {//
            this.callback = signalingInterface
            //this.callback=ioSocket
            try {

                //set the socket.io url here
                socket = ioSocket.mSocket
        ...
        fun emitInitStatement(message: String) {
